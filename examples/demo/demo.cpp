...
void load_model(simple_model & model, float * a, float * b, float * c, int rows_A, int cols_A, int rows_B, int cols_B, int rows_C, int cols_C) {
    ...
    model.c = ggml_new_tensor_2d(model.ctx, GGML_TYPE_F32, cols_C, rows_C);
...
struct ggml_cgraph * build_graph(const simple_model& model) {
    ...
    struct ggml_tensor * result2 = ggml_mul_mat(ctx0, result, model.c);
...
int main(void) {
    ...
    simple_model model;
    load_model(model, matrix_A, matrix_B, matrix_C, rows_A, cols_A, rows_B, cols_B, rows_C, cols_C);
